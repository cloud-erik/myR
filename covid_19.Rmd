...
On the time-line clearly the is a close relationship between the cases and recovered cases are visible. Also the created simple linear model performs quite good in predicting the recovered cases per poulation.
